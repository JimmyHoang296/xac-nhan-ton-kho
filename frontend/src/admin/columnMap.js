...
export const TABLES = {
  ...
  stores: [
    ...
    ['long', 'long'],
    ['cht', 'cht'],       ['CHT', 'cht'],
    ['sdt_cht', 'sdt_cht'], ['SDT CHT', 'sdt_cht'],
    ['qlkv', 'qlkv'],     ['QLKV', 'qlkv'],
    ['sdt_qlkv', 'sdt_qlkv'], ['SDT QLKV', 'sdt_qlkv'],
    ['qlkv_id', 'qlkv_id'], ['QLKV id', 'qlkv_id'],
    ['gdv', 'gdv'],       ['GDV', 'gdv'],
    ['gdv_id', 'gdv_id'], ['GDV id', 'gdv_id'],
    ['gdm', 'gdm'],       ['GDM', 'gdm'],
    ['gdm_id', 'gdm_id'], ['GDM id', 'gdm_id'],
    ['gdc', 'gdc'],       ['GDC', 'gdc'],
    ['gdc_id', 'gdc_id'], ['GDC id', 'gdc_id'],
    ['kstt', 'kstt'],     ['KSTT', 'kstt'],
    ['chuoi', 'chuoi'],
  ],
  PIC: [
